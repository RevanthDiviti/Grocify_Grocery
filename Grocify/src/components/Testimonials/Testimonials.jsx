...
const review = [
  {
    ...
    rating: 3,
    para: "Grocify is my go-to store for all grocery needs. Their produce is always fresh, and the delivery is super fast. I love the user-friendly inteface and variety of organic options!",
    image: Customer1,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    profession: "Model",
    rating: 3,
    para: "Shopping online with Grocify has saved me so much time. I trust them for my family's weekly groceries-always fresh, affordable, and reliable.",
    image: Customer3,
  },
  {
    id: 4,
